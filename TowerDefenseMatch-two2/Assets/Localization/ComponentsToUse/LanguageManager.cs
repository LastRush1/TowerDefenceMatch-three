...
namespace SimpleLocalizator {
	public class LanguageManager : MonoBehaviour {
		...
		public void SetGermanLang() //Добавляй подобные методы, когда нужен новый язык!!!
		{
        ...
        public static Language GetSystemLanguage() { //Выбирает язык в зависимости от языка системы, каеф
